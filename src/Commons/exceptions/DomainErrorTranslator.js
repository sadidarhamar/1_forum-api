...
DomainErrorTranslator._directories = {
  ...
  'NEW_THREAD.NOT_CONTAIN_NEEDED_PROPERTY': new InvariantError(
    'tidak dapat membuat trit baru karena properti yang dibutuhkan tidak ada',
  ),
  'NEW_THREAD.NOT_MEET_DATA_TYPE_SPECIFICATION': new InvariantError(
    'tidak dapat membuat trit baru karena tipe data tidak sesuai',
  ),
  'NEW_THREAD.TITLE_LIMIT_CHAR': new InvariantError(
    'tidak dapat membuat trit baru karena karakter judul melebihi batas limit',
  ),

  'NEW_COMMENT.NOT_CONTAIN_NEEDED_PROPERTY': new InvariantError(
    'tidak dapat membuat komenter karena properti yang dibutuhkan tidak ada',
  ),

  'NEW_COMMENT.NOT_MEET_DATA_TYPE_SPECIFICATION': new InvariantError(
    'tidak dapat membuat komenter karena tipe data tidak sesuai',
  ),
